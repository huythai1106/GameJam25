...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty activeSprite;
    private SerializedProperty inactiveSprite;
    ...
    protected virtual void OnEnable()
    {
        ...
        inactiveSprite = serializedObject.FindProperty("inactiveSprite");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(activeSprite, new GUIContent("ActiveSprite", ""));
        EditorGUILayout.ObjectField(inactiveSprite, new GUIContent("InactiveSprite", ""));
    }
}